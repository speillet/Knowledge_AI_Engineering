...
Qu'est-ce que MCP ?
?
Le **Model Context Protocol** : un **standard ouvert** (initié par Anthropic) pour connecter les applications IA à des outils et sources de données via une architecture client-serveur.
...
?
**Serveurs tiers non audités, [[101-securite-llm-guardrails|prompt injection]] via les résultats d'outils, permissions trop larges** — d'où sandboxing et validation humaine des actions sensibles.
